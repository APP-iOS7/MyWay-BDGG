...
//   List<String> generateWeeklyRanges(DateTime startDate, DateTime endDate) {
//     List<String> ranges = [];
...
//       final rangeEnd = end.isAfter(endDate) ? endDate : end;

//       final label =
//           '${start.month}월 ${start.day}일 ~ ${rangeEnd.month}월 ${rangeEnd.day}일';
//       ranges.add(label);

//       current = rangeEnd.add(const Duration(days: 1));
//     }

//     return ranges;
//   }

//   List<DateTime> parseRange(String label) {
...
//                   value: activityProvider.selectedRange,
//                   items:
